...
const RequestsCard: React.FC<Props> = ( {id, training_name, description, category, duration, provider, training_code, onDelete} ) => {
    ...
    return (
        <div className="px-5 py-7 bg-white shadow-xs shadow-secondary/30 flex flex-col">
            <div className="w-full flex items-center justify-between mb-5">
               ...
               <div className="py-1 px-3 rounded-md flex items-center justify-center bg-orange-300">
                  <label className="flex items-center gap-2 text-xs font-semibold"><FaRegClock /> Awaiting approval</label>
               </div>
            </div>
            ...
            <div className="mt-4 flex items-center justify-between">
               ...
               <div className="flex gap-5 items-center text-sm">
                  <GrEdit onClick={() => navigate(`/staff/request_training/request_details/${id}`)} className="cursor-pointer hover:text-primary" />
