    ...
    return (
        <div className="w-full py-3 bg-white border-l border-l-secondaryy flex px-6 justify-between items-center">
            ...
            <div className="flex items-center gap-5">
                <MdOutlineSpaceDashboard className="font-bold text-xl flex xl:hidden" />
            ...
            <div className="flex items-center gap-3">
                ...
                <div className="flex gap-1 items-center">
                   ...
                   <div className="h-8">
                     <div className="text-white flex items-center -ml-1 justify-center w-4 p-1 h-4 rounded-full bg-red-600">
