...
import RequestTrainingInfo from "./components/RequestTrainingInfo";
import RequestAssigneeInfo from "./components/RequestAssigneeInfo";
       ...
       <div className="w-full min-h-screen flex">
          ...
          <div className="w-full xl:w-[82%] min-h-screen text-secondary/80 bg-secondaryy">
           ...
           <div className="w-full flex flex-col lg:flex-row items-start gap-5 justify-between mb-6 ">
              <RequestTrainingInfo />
              {/* <RequestAssigneeInfo setShowCertificate={setShowCertificate} /> */}
           </div>
